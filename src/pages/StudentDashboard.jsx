...
import { getNetworkStats, isLinkedInConnected } from '../services/linkedinService';
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        const [userSessions, stats] = await Promise.all([
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {showCoachList && !selectedCoach && (
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-screen items-center justify-center p-4">
              <div className="fixed inset-0 bg-black bg-opacity-25" onClick={() => setShowCoachList(false)} />
        ...
        {selectedCoach && (
          <div className="fixed inset-0 z-50 overflow-y-auto">
            <div className="flex min-h-screen items-center justify-center p-4">
              <div className="fixed inset-0 bg-black bg-opacity-25" onClick={() => setSelectedCoach(null)} />
              <div className="relative w-full max-w-2xl">
                <SessionScheduler
                  coach={selectedCoach}
