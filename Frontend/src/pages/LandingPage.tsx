...
export default function LandingPage() {
  ...
  const [authModalView, setAuthModalView] = React.useState<'login' | 'signup'>('login');
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-semibold text-gray-900">Trusted by professionals from</h2>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center justify-items-center">
                ...
                <img src="https://upload.wikimedia.org/wikipedia/commons/9/95/Instagram_logo_2022.svg" alt="Meta" className="h-8 opacity-50 hover:opacity-75 transition-opacity" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-white py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="text-center mb-12">
                ...
                <p className="mt-4 text-lg text-gray-600">Join thousands of professionals who've transformed their careers</p>
              </div>
...
const testimonials = [
  {
    ...
    quote: "CareerLaunch AI helped me optimize my LinkedIn presence and connect with the right people. Within months, I landed my dream job!",
    image: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
  },
  {
    name: "Marcus Rodriguez",
    role: "Product Manager at Meta",
    quote: "The AI-powered content suggestions are incredible. My engagement rates have tripled since I started using CareerLaunch.",
    image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"
  },
  {
    name: "Emily Watson",
    role: "Marketing Director at Netflix",
    quote: "The network analytics helped me identify key industry connections I was missing. Game-changing for career growth!",
